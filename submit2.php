...
<?php 
	$debug = true;
	$filename = 'labs' . $_POST['courseName'] . '.php';
	require $filename;
...
?>
  ...
  <p align="left"><strong>Instructions (step 2 of 4)</strong></p>
  <ol>
	<li>Select the name of the assignment from the drop down list.</li>
